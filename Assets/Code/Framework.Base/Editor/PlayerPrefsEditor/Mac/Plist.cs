...
namespace General.PlayerPrefsExtensions.Editor
{
    public static class Plist
    {
        ...
        public static object readPlistSource(string source) => readPlist(Encoding.UTF8.GetBytes(source));

        public static object readPlist(byte[] data) => readPlist(new MemoryStream(data), plistType.Auto);
        ...
        private static void composeArray(List<object> value, XmlWriter writer)
        {
            ...
            foreach (object obj in value) compose(obj, writer);
        ...
        private static void compose(object value, XmlWriter writer)
        {
                     ...
                     value.GetType().ToString().StartsWith("System.Collections.Generic.Dictionary`2[System.String"))
            {
                ...
                if (dic == null)
                {
                    ...
                    foreach (object key in idic.Keys) dic.Add(key.ToString(), idic[key]);
                }
        ...
        private static int countObject(object value)
        {
            ...
            switch (value.GetType().ToString())
            {
                case "System.Collections.Generic.Dictionary`2[System.String,System.Object]":
                    ...
                    foreach (string key in dict.Keys) count += countObject(dict[key]);
                    count += dict.Keys.Count;
                    count++;
                    break;
                case "System.Collections.Generic.List`1[System.Object]":
                    List<object> list = (List<object>)value;
                    foreach (object obj in list) count += countObject(obj);
                    count++;
                    break;
                default:
                    count++;
        ...
        private static byte[] writeBinaryDictionary(Dictionary<string, object> dictionary)
        {
            ...
            for (int i = dictionary.Count - 1; i >= 0; i--)
            {
                string[] o = new string[dictionary.Count];
        ...
        private static byte[] RegulateNullBytes(byte[] value) => RegulateNullBytes(value, 1);
        ...
        private static object parseBinaryArray(int objRef)
        {
            ...
            for (int i = 0; i < refCount; i++) buffer.Add(parseBinary(refs[i]));
        ...
        private static object parseBinary(int objRef)
        {
            ...
            switch (header & 0xF0)
            {
                case 0:
                {
                    ...
                    //9 return true
                    //8 return false
                    return objectTable[offsetTable[objRef]] == 0 ? (object)null :
